...
// This class uses the sun exposure model for a user profile
...
public class SunExAi {
    ...
    public SunExAi(SensorReadingService sensorReadingService) throws Exception {
        // The model is loaded once so predictions can be made later
    ...
    public int predict(double SkinType, double Age) {
        try {
            // The model uses time, UV level, skin type, and age
